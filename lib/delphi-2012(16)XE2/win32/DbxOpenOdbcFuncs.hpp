...
// (DO NOT EDIT: machine generated header) 'DbxOpenOdbcFuncs.pas' rev: 23.00 (Win32)
...
extern PACKAGE System::AnsiString __fastcall GetOptionValue(System::AnsiString &ConnectString, System::AnsiString OptionName, bool HideOption = false, bool TrimResult = true, bool bOneChar = false, const System::AnsiString HideTemplate = System::AnsiString());
...
extern PACKAGE bool __fastcall PrepareFileNameAliases(System::UnicodeString &FileName, const System::UnicodeString AppFolder = System::UnicodeString(), const System::UnicodeString TempFolder = System::UnicodeString())/* overload */;
extern PACKAGE bool __fastcall PrepareFileNameAliases(System::AnsiString &FileName, const System::AnsiString AppFolder = System::AnsiString(), const System::AnsiString TempFolder = System::AnsiString())/* overload */;
