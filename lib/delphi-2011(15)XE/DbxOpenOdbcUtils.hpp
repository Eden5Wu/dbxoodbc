...
// (DO NOT EDIT: machine generated header) 'DbxOpenOdbcUtils.pas' rev: 22.00
...
extern PACKAGE int __fastcall StringsToWStr(const Classes::TStrings* L, System::WideChar * &Dest)/* overload */;
