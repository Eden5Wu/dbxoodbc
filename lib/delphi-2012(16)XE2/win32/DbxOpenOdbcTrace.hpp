...
// (DO NOT EDIT: machine generated header) 'DbxOpenOdbcTrace.pas' rev: 23.00 (Win32)
...
extern PACKAGE void __fastcall LogEnterProc(const System::AnsiString ProcName, const System::AnsiString Params = System::AnsiString())/* overload */;
...
extern PACKAGE void __fastcall LogInfoProc(const System::AnsiString Params = System::AnsiString())/* overload */;
extern PACKAGE void __fastcall LogInfoProc(System::TVarRec const *Params, const int Params_Size)/* overload */;
extern PACKAGE void __fastcall LogExitProc(const System::AnsiString ProcName, const System::AnsiString ExitInfo = System::AnsiString())/* overload */;
...
extern PACKAGE void __fastcall LogExceptProc(const System::AnsiString ProcName, System::Sysutils::Exception* E, const System::AnsiString ExceptInfo = System::AnsiString())/* overload */;
extern PACKAGE void __fastcall LogExceptProc(const System::AnsiString ProcName, System::Sysutils::Exception* E, System::TVarRec const *ExceptInfo, const int ExceptInfo_Size)/* overload */;
