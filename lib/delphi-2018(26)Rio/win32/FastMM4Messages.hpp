...
// (DO NOT EDIT: machine generated header) 'FastMM4Messages.pas' rev: 33.00 (Windows)
...
#define LeakMessageFooter L"\r\n\r\nNote: To obtain a log file containing detail on me"\
	L"mory leaks, enable the \"FullDebugMode\" and \"LogMemoryLe"\
	L"akDetailToFile\" conditional defines. To disable this memo"\
	L"ry leak check, undefine \"EnableMemoryLeakReporting\".\r\n"\
	L"\u0000"
