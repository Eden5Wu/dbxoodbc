...
// (DO NOT EDIT: machine generated header) 'DbxOpenOdbcCallback.pas' rev: 23.00 (Win32)
...
extern PACKAGE int __fastcall GetTraceFlag(const Data::Dbxcommon::TDBXTraceInfo &TraceInfo);
extern PACKAGE System::UnicodeString __fastcall GetTraceFlagName(System::Word TraceFlag)/* overload */;
extern PACKAGE System::UnicodeString __fastcall GetTraceFlagName(const Data::Dbxcommon::TDBXTraceInfo &TraceInfo)/* overload */;
extern PACKAGE System::UnicodeString __fastcall GetTraceMessage(const Data::Dbxcommon::TDBXTraceInfo &TraceInfo);
extern PACKAGE void __fastcall DecodeTraceInfo(const Data::Dbxcommon::TDBXTraceInfo &TraceInfo, int &TraceFlag, System::UnicodeString &TraceFlagName, System::UnicodeString &TraceMessage);
