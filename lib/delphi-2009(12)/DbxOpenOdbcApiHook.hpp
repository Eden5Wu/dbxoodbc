...
// (DO NOT EDIT: machine generated header) 'Dbxopenodbcapihook.pas' rev: 20.00
...
public:
	StaticArray<System::WideChar, 261> LibraryName;
	StaticArray<System::WideChar, 256> FunctionName;
	void *FunctionAddr;
