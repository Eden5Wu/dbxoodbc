...
// (DO NOT EDIT: machine generated header) 'DbxOpenOdbcInterface.pas' rev: 33.00 (Windows)
...
__interface DELPHIINTERFACE IBlobChunkCollection;
...
typedef void __fastcall (*TRegisterDbXpressLib)();
...
{
	virtual System::AnsiString __stdcall GetDbmsName() = 0 ;
	virtual TDbmsType __stdcall GetDbmsType() = 0 ;
	virtual System::AnsiString __stdcall GetDbmsVersionString() = 0 ;
	virtual int __stdcall GetDbmsVersionMajor() = 0 ;
	virtual int __stdcall GetDbmsVersionMinor() = 0 ;
	virtual int __stdcall GetDbmsVersionRelease() = 0 ;
	virtual char * __stdcall GetLastOdbcSqlState() = 0 ;
	virtual void __stdcall GetOdbcConnectStrings(System::Classes::TStrings* ConnectStringList) = 0 ;
	virtual System::AnsiString __stdcall GetOdbcDriverName() = 0 ;
	virtual TOdbcDriverType __stdcall GetOdbcDriverType() = 0 ;
	virtual System::AnsiString __stdcall GetOdbcDriverVersionString() = 0 ;
	virtual int __stdcall GetOdbcDriverVersionMajor() = 0 ;
	virtual int __stdcall GetOdbcDriverVersionMinor() = 0 ;
	virtual int __stdcall GetOdbcDriverVersionRelease() = 0 ;
	virtual int __stdcall GetDbmsVersionBuild() = 0 ;
	virtual int __stdcall GetOdbcDriverVersionBuild() = 0 ;
	virtual bool __stdcall GetCursorPreserved() = 0 ;
	virtual bool __stdcall GetIsSystemODBCManager() = 0 ;
	virtual int __stdcall GetOdbcDriverLevel() = 0 ;
	virtual bool __stdcall GetSupportsSqlPrimaryKeys() = 0 ;
	virtual int __stdcall GetStatementsPerConnection() = 0 ;
	virtual void * __stdcall GetEnvironmentHandle() = 0 ;
	virtual void * __stdcall GetConnectionHandle() = 0 ;
	virtual System::_di_IInterface __stdcall GetOdbcApiIntf() = 0 ;
	virtual char __stdcall GetDecimalSeparator() = 0 ;
};
...
__interface  INTERFACE_UUID("{136DD9D1-9B9C-4355-9AEF-959662CB095F}") ISqlCommandOdbc  : public System::IInterface 
{
	...
	virtual int __stdcall GetLockTimeout() = 0 ;
};
...
{
	virtual __int64 __stdcall GetSize() = 0 ;
...
extern DELPHI_PACKAGE void __fastcall RegisterDbXpressLibA();
extern DELPHI_PACKAGE void __fastcall RegisterDbXpressLibAW();
extern DELPHI_PACKAGE void __fastcall RegisterDbXpressLibW();
extern DELPHI_PACKAGE void __fastcall RegisterDbXpressLibWA();
