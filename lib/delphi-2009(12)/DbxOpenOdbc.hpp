...
// (DO NOT EDIT: machine generated header) 'Dbxopenodbc.pas' rev: 20.00
...
public:
	StaticArray<System::WideChar, 1024> pszTrace;
	int eTraceCat;
	int ClientData;
...
public:
	StaticArray<char, 1024> pszTrace;
	int eTraceCat;
	int ClientData;
	System::Word uTotalMsgLen;
};
...
typedef StaticArray<TConnectionOptionsRestriction, 38> TConnectionOptionsRestrictions;

#pragma option push -b-
enum TBindMapDateTimeOdbcIndexes { biDate, biTime, biDateTime };
#pragma option pop

typedef StaticArray<int, 3> TBindMapDateTimeOdbc;
...
protected:
	...
	System::AnsiString __stdcall GetDbmsName();
	Dbxopenodbcinterface::TDbmsType __stdcall GetDbmsType(void);
	System::AnsiString __stdcall GetDbmsVersionString();
	...
	System::AnsiString __stdcall GetOdbcConnectString();
	void __stdcall GetOdbcConnectStrings(Classes::TStrings* ConnectStringList);
	System::AnsiString __stdcall GetOdbcDriverName();
	Dbxopenodbcinterface::TOdbcDriverType __stdcall GetOdbcDriverType(void);
	System::AnsiString __stdcall GetOdbcDriverVersionString();
...
protected:
	...
	System::AnsiString __fastcall BuildStoredProcSQL();
...
private:
	typedef DynamicArray<short> _TSqlCursorOdbc__1;
...
typedef DynamicArray<System::AnsiString> TColumnNames;

typedef DynamicArray<System::Word> TColumnTypes;
...
typedef StaticArray<System::Byte, 256> TArrayOfBytes;

typedef TArrayOfBytes *PArrayOfBytes;

typedef StaticArray<System::Word, 129> TArrayOfWords;
...
struct TOdbcBindParamRec
{
	...
	union
	{
		...
		struct 
		{
			StaticArray<System::WideChar, 129> OdbcParamValueWideString;
			
		};
		struct 
		{
			StaticArray<char, 256> OdbcParamValueString;
...
static const ShortInt cConnectionTimeoutDefault = -1;
...
static const ShortInt coNetTimeoutDefault = -1;
static const ShortInt cLockModeDefault = -1;
