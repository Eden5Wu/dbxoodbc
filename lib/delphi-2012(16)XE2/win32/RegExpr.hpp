...
// (DO NOT EDIT: machine generated header) 'RegExpr.pas' rev: 23.00 (Win32)
...
typedef System::Set<char, 0, 255>  TSetOfREChar;
...
public:
	...
	/* Exception.CreateRes */ inline __fastcall ERegExpr(int Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall ERegExpr(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_Size) { }
	...
	/* Exception.CreateResHelp */ inline __fastcall ERegExpr(int Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
...
extern PACKAGE void __fastcall SplitRegExpr(const System::AnsiString ARegExpr, const System::AnsiString AInputStr, System::Classes::TStrings* APieces);
...
extern PACKAGE int __fastcall RegExprSubExpressions(const System::UnicodeString ARegExpr, System::Classes::TStrings* ASubExprs, bool AExtendedSyntax = false);
