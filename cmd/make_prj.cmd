...
@set make_prj_ver=2018.07.25
@rem #
@rem # make_prj Version 2018.07.25
@rem # ======================
@rem # Description:
@rem # ======================
@rem # Compilation: Support RAD Studio 10.2 Tokyo
@rem #
@rem # Copyright (c) 2018
@rem # by "Eden Wu" <http://grandruru.blogspot.tw>
@rem #
@rem #
...
@set berlin=
@if %DVER% == 24 set ide_name=RAD Studio 10.1 Berlin

@set tokyo=
@if %DVER% == 25 set ide_name=RAD Studio 10.2 Tokyo

@if %DVER% GEQ 24  set /a DVER+=1
...
@if "%indy%" NEQ "09" @set DLib=%DLib%;%DELPHI_ROOTDIR%\%PLIB%\indy10
  @rem Add OODBC Source folders
@set DLIB=%DLib%;".\..\..\source\packages";".\..\..\source\driver"
...
@echo        25       - RAD Studio 10.2 Tokyo for win32>con
@echo        24       - RAD Studio 10.1 Berlin for win32>con
