...
// (DO NOT EDIT: machine generated header) 'Dbx34drv.pas' rev: 20.00
...
public:
	static const ShortInt TimeStampOffsetType = 0x24;
...
enum Dbx34drv__41 { mmSQL, mmDBX };
#pragma option pop

typedef Set<Dbx34drv__41, mmSQL, mmDBX>  TMetadataMode;
...
protected:
	...
	virtual Dbxplatform::TDBXStringArray __fastcall GetReservedWords();
