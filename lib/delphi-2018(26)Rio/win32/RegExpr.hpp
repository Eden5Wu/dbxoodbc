...
// (DO NOT EDIT: machine generated header) 'RegExpr.pas' rev: 33.00 (Windows)
...
private:
	...
	System::AnsiString __fastcall GetExpression();
	void __fastcall SetExpression(const System::AnsiString s);
	System::AnsiString __fastcall GetModifierStr();
	...
	System::AnsiString __fastcall GetInputString();
	...
	System::AnsiString __fastcall GetLinePairedSeparator();
