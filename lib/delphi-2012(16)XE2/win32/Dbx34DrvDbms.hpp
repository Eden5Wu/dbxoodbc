...
// (DO NOT EDIT: machine generated header) 'Dbx34DrvDbms.pas' rev: 23.00 (Win32)
...
protected:
	...
	virtual void __fastcall PopulateDataTypes(const Data::Dbxplatform::TDBXObjectStore* Hash, const Data::Dbxplatform::TDBXArrayList* Types, const Data::Dbxmetadatareader::TDBXDataTypeDescriptionArray Descr);
