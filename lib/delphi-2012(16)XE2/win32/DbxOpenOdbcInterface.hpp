...
// (DO NOT EDIT: machine generated header) 'DbxOpenOdbcInterface.pas' rev: 23.00 (Win32)
...
#pragma option push -b-
enum TOptionSwitches : unsigned char { osDefault, osOff, osOn };
#pragma option pop
...
#pragma option push -b-
enum TXSQLDriverOption : unsigned char { xeDrvBlobSize, xeDrvCallBack, xeDrvCallBackInfo, xeDrvRestrict, xeDrvVersion, xeDrvProductVersion };
#pragma option pop
...
#pragma option push -b-
enum TOdbcApiType : unsigned char { oaAnsi, oaAnsiToUnicode, oaUnicode, oaUnicodeToAnsi };
#pragma option pop
