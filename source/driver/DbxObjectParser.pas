{
  ...
  Copyright (c) 2002-2012 by Vadim V.Lopushansky
...
{.$DEFINE _RegExpr_DumpMatchPos_} // @dbg
...
type
  ...
  public
    ...
    function EncodeObjectFullName((*{$IFNDEF _D11UP_}const{$ENDIF}*) CatalogName, SchemaName, ObjectName: AnsiString;
      pTemplateInfo: PObjectNameTemplateInfo = nil): AnsiString;
    function GetQuotedObjectName((*{$IFNDEF _D11UP_}const{$ENDIF}*) ObjectName: AnsiString): AnsiString;
  end;
