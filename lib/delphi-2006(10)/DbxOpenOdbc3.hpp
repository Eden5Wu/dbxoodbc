...
// (DO NOT EDIT: machine generated header) 'Dbxopenodbc3.pas' rev: 10.00
...
public:
	...
	__fastcall TSqlCursorMetaDataEmpty(TSqlConnectionOdbc3* AConnection, AnsiString * AColNames, const int AColNames_Size, Word * AColTypes, const int AColTypes_Size)/* overload */;
