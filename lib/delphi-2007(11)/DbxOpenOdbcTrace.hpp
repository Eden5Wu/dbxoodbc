...
// (DO NOT EDIT: machine generated header) 'Dbxopenodbctrace.pas' rev: 11.00
...
{
//-- type declarations -------------------------------------------------------
typedef Dbxopenodbcdbx3types::TTransactionDesc *pTTransactionDescBase;
...
extern PACKAGE AnsiString __fastcall GetTransactionDescStr(Dbxopenodbcdbx3types::pTTransactionDesc TranID);
