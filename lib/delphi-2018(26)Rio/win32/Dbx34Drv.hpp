...
// (DO NOT EDIT: machine generated header) 'Dbx34Drv.pas' rev: 33.00 (Windows)
...
public:
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EDbxOODBCDriverError() { }
...
public:
	/* TObject.Create */ inline __fastcall TDBXOpenOdbcPropertyNames() : Data::Dbxcommon::TDBXPropertyNames() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TDBXOpenOdbcPropertyNames() { }
...
public:
	/* TObject.Create */ inline __fastcall TDBXPropertyNames() : TDBXOpenOdbcPropertyNames() { }
...
public:
	/* TDBXDynalinkDriver.Destroy */ inline __fastcall virtual ~TDbxOpenOdbcDriver() { }
	
public:
	/* TDBXDriver.Create */ inline __fastcall TDbxOpenOdbcDriver()/* overload */ : Data::Dbxdynalinknative::TDBXDynalinkDriverNative() { }
...
private:
	...
	System::UnicodeString __fastcall GetOdbcTransIsolation();
	...
	System::UnicodeString __fastcall GetCustomString();
...
public:
	/* TDBXProperties.Create */ inline __fastcall virtual TDBXOpenOdbcProperties()/* overload */ : Data::Dbxcommon::TDBXProperties() { }
	/* TDBXProperties.Destroy */ inline __fastcall virtual ~TDBXOpenOdbcProperties() { }
...
private:
	HIDESBASE void __fastcall FreeOldLibrary();
...
public:
	/* TDBXDynalinkDriverCommonLoader.Create */ inline __fastcall virtual TDBXDynalinkDriverLoaderOpenOdbc() : Data::Dbxdynalinknative::TDBXDynalinkDriverLoader() { }
	
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TDBXDynalinkDriverLoaderOpenOdbc() { }
...
private:
	...
	void __fastcall DoDerivedOpenBefore();
	void __fastcall DoDerivedOpenAfter();
...
protected:
	...
	virtual Data::Dbxcommon::TDBXCommand* __fastcall DerivedCreateCommand();
...
public:
	/* TDBXConnection.Destroy */ inline __fastcall virtual ~TDBXDynalinkConnectionOpenOdbc() { }
...
public:
	/* TDBXMorphicCommand.Destroy */ inline __fastcall virtual ~TDBXMorphicCommandOpenOdbc() { }
...
public:
	/* TDBXDataExpressProviderContext.Create */ inline __fastcall TDBXDataExpressProviderContextOpenOdbc() : Data::Dbxmetadatacommandfactory::TDBXDataExpressProviderContext() { }
	/* TDBXDataExpressProviderContext.Destroy */ inline __fastcall virtual ~TDBXDataExpressProviderContextOpenOdbc() { }
...
protected:
	...
	bool __fastcall GetUseAnsiStrings();
public:
	/* TDBXBaseMetaDataReader.Destroy */ inline __fastcall virtual ~TDBXCustomOpenODBCMetaDataReader() { }
	
public:
	/* TObject.Create */ inline __fastcall TDBXCustomOpenODBCMetaDataReader() : Data::Dbxmetadatareader::TDBXBaseMetaDataReader() { }
...
public:
	...
	/* TDBXMetaDataCommand.Destroy */ inline __fastcall virtual ~TDBXOpenODBCMetaDataCommand() { }
...
public:
	/* TObject.Create */ inline __fastcall TDBXOpenODBCMetaDataCommandFactory() : Data::Dbxmetadatacommandfactory::TDBXMetaDataCommandFactory() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TDBXOpenODBCMetaDataCommandFactory() { }
...
public:
	virtual Data::Dbxmetadatareader::TDBXMetaDataReader* __fastcall CreateMetaDataReader()/* overload */;
public:
	/* TObject.Create */ inline __fastcall TDBXOpenODBCMetaDataCommandFactoryCustom() : TDBXOpenODBCMetaDataCommandFactory() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TDBXOpenODBCMetaDataCommandFactoryCustom() { }
...
public:
	__fastcall virtual TDBXOpenODBCMetaDataReader();
...
public:
	/* TDBXBaseMetaDataReader.Destroy */ inline __fastcall virtual ~TDBXOpenODBCMetaDataReader() { }
