...
// (DO NOT EDIT: machine generated header) 'DbxOpenOdbcDbx3Types.pas' rev: 6.00
...
typedef wchar_t DBINAME128[129];
...
public:
	...
	virtual int __stdcall connect(wchar_t * ServerName, wchar_t * UserName, wchar_t * Password) = 0 /* overload */;
	...
	virtual int __stdcall getErrorMessage(wchar_t * Error) = 0 /* overload */;
...
public:
	...
	virtual int __stdcall prepare(wchar_t * SQL, Word ParamCount) = 0 ;
	virtual int __stdcall execute(_di_ISQLCursor30 &Cursor) = 0 ;
	virtual int __stdcall executeImmediate(wchar_t * SQL, _di_ISQLCursor30 &Cursor) = 0 ;
...
public:
	...
	virtual int __stdcall getColumnName(Word ColumnNumber, wchar_t * pColumnName) = 0 ;
	...
	virtual int __stdcall getWideString(Word ColumnNumber, wchar_t * Value, BOOL &IsBlank) = 0 ;
...
public:
	...
	virtual int __stdcall getTables(wchar_t * TableName, unsigned TableType, /* out */ _di_ISQLCursor30 &Cursor) = 0 ;
	virtual int __stdcall getProcedures(wchar_t * ProcedureName, unsigned ProcType, /* out */ _di_ISQLCursor30 &Cursor) = 0 ;
	virtual int __stdcall getColumns(wchar_t * TableName, wchar_t * ColumnName, unsigned ColType, /* out */ _di_ISQLCursor30 &Cursor) = 0 ;
	virtual int __stdcall getProcedureParams(wchar_t * ProcName, wchar_t * ParamName, /* out */ _di_ISQLCursor30 &Cursor) = 0 ;
	virtual int __stdcall getIndices(wchar_t * TableName, unsigned IndexType, /* out */ _di_ISQLCursor30 &Cursor) = 0 ;
	virtual int __stdcall getErrorMessage(wchar_t * Error) = 0 /* overload */;
	virtual int __stdcall getErrorMessageLen(/* out */ short &ErrorLen) = 0 ;
};
...
typedef DynamicArray<wchar_t >  TDBXWideChars;
...
typedef wchar_t *TDBXWideStringVar;

typedef char *TDBXAnsiStringVar;

typedef wchar_t *TDBXWideStringBuilder;
