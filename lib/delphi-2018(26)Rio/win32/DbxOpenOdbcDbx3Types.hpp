...
// (DO NOT EDIT: machine generated header) 'DbxOpenOdbcDbx3Types.pas' rev: 33.00 (Windows)
...
{
	virtual System::TObject* __stdcall SelfObj() = 0 ;
};
...
{
	virtual int __stdcall connect() = 0 /* overload */;
