...
// (DO NOT EDIT: machine generated header) 'DbxOpenOdbcApiHook.pas' rev: 23.00 (Win32)
...
extern PACKAGE void * __fastcall FxtGetStubAddress(void * AStub, int OffsetE8 = (int)(0x0));
