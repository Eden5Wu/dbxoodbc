...
// (DO NOT EDIT: machine generated header) 'DbxOpenOdbc.pas' rev: 33.00 (Windows)
...
public:
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EDbxErrorCustom() { }
...
public:
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EDbxOdbcWarning() { }
...
public:
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EDbxError() { }
...
public:
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EDbxOdbcError() { }
...
public:
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EDbxNotSupported() { }
...
public:
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EDbxInvalidCall() { }
...
public:
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EDbxInternalError() { }
...
public:
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EDbxInvalidParam() { }
...
protected:
	...
	System::TObject* __stdcall SelfObj();
	
public:
	__property TDOSQLObjectType ObjectType = {read=FObjectType, nodefault};
public:
	/* TObject.Create */ inline __fastcall TDOSQLObject() : System::TInterfacedObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TDOSQLObject() { }
...
public:
	...
	__fastcall virtual ~TSqlDriverOdbc();
...
protected:
	...
	void __fastcall CheckTransactionSupport();
	void __fastcall CheckDbmsTransactionSupport();
	...
	PDbxConStmt __fastcall GetCurrentDbxConStmt()/* overload */;
	PDbxConStmt __fastcall GetCurrentDbxConStmt(/* out */ void * &HStmt)/* overload */;
	void * __fastcall GetCurrentConnectionHandle();
	...
	int __fastcall RetrieveDriverName();
	int __fastcall RetrieveDbmsOptions();
	...
	void __fastcall ClearConnectionOptions();
	...
	Dbxopenodbcinterface::PConnectionOptions __fastcall GetDefaultConnectionOptions();
	...
	void __fastcall ReleaseRegExpObjectNameParser();
	...
	Dbxopenodbcinterface::TDbmsType __stdcall GetDbmsType();
	System::AnsiString __stdcall GetDbmsVersionString();
	int __stdcall GetDbmsVersionMajor();
	int __stdcall GetDbmsVersionMinor();
	int __stdcall GetDbmsVersionRelease();
	int __stdcall GetDbmsVersionBuild();
	char * __stdcall GetLastOdbcSqlState();
	...
	Dbxopenodbcinterface::TOdbcDriverType __stdcall GetOdbcDriverType();
	System::AnsiString __stdcall GetOdbcDriverVersionString();
	int __stdcall GetOdbcDriverVersionMajor();
	int __stdcall GetOdbcDriverVersionMinor();
	int __stdcall GetOdbcDriverVersionRelease();
	int __stdcall GetOdbcDriverVersionBuild();
	bool __stdcall GetCursorPreserved();
	bool __stdcall GetIsSystemODBCManager();
	int __stdcall GetOdbcDriverLevel();
	bool __stdcall GetSupportsSqlPrimaryKeys();
	int __stdcall GetStatementsPerConnection();
	void * __stdcall GetEnvironmentHandle();
	void * __stdcall GetConnectionHandle();
	System::_di_IInterface __stdcall GetOdbcApiIntf();
	char __stdcall GetDecimalSeparator();
	
public:
	__fastcall virtual TSqlConnectionOdbc(TSqlDriverOdbc* OwnerDbxDriver);
	__fastcall virtual ~TSqlConnectionOdbc();
...
protected:
	...
	void * __fastcall GetConnectionHandle();
	void __fastcall DoAllocateStmt();
	void __fastcall DoUnprepareStmt();
	short __fastcall DoSQLMoreResults();
...
public:
	...
	__fastcall virtual ~TSQLMetaDataOdbc();
private:
...
public:
	...
	__fastcall virtual ~TSqlCursorOdbc();
private:
...
public:
	...
	__fastcall virtual ~TMetaColumn();
};
...
public:
	...
	__fastcall virtual ~TMetaIndexColumn();
};
...
public:
	...
	__fastcall virtual ~TMetaProcedure();
};
...
public:
	...
	__fastcall virtual ~TMetaProcedureParam();
};
...
public:
	...
	__fastcall virtual ~TSqlCursorMetaData();
private:
	void *__ISQLCursor25;	// Dbxopenodbcdbx3types::ISQLCursor25 
...
public:
	...
	__fastcall virtual ~TSqlCursorMetaDataTables();
private:
	void *__ISQLCursor25;	// Dbxopenodbcdbx3types::ISQLCursor25 
...
public:
	...
	__fastcall virtual ~TSqlCursorMetaDataColumns();
private:
	void *__ISQLCursor25;	// Dbxopenodbcdbx3types::ISQLCursor25 
...
public:
	...
	__fastcall virtual ~TSqlCursorMetaDataIndexes();
private:
	void *__ISQLCursor25;	// Dbxopenodbcdbx3types::ISQLCursor25 
...
public:
	...
	__fastcall virtual ~TSqlCursorMetaDataProcedures();
private:
	void *__ISQLCursor25;	// Dbxopenodbcdbx3types::ISQLCursor25 
...
public:
	...
	__fastcall virtual ~TSqlCursorMetaDataProcedureParams();
private:
	void *__ISQLCursor25;	// Dbxopenodbcdbx3types::ISQLCursor25 
...
public:
	__fastcall virtual ~TBlobChunkCollection();
	void __fastcall AddFragment(void * Data, int DataSize);
public:
	/* TObject.Create */ inline __fastcall TBlobChunkCollection() : System::TInterfacedObject() { }
...
public:
	...
	short fReadOnly;
	__fastcall TOdbcBindCol();
	__fastcall virtual ~TOdbcBindCol();
};
...
public:
	__fastcall TOdbcBindParam();
	__fastcall virtual ~TOdbcBindParam();
};
