...
// (DO NOT EDIT: machine generated header) 'Dbxopenodbccallback.pas' rev: 10.00
...
{
//-- type declarations -------------------------------------------------------
typedef Sqlexpr::SQLTRACEDesc30 *TDBXTraceInfo;
...
extern PACKAGE int __fastcall GetTraceFlag(const Sqlexpr::pSQLTRACEDesc30 TraceInfo);
extern PACKAGE AnsiString __fastcall GetTraceFlagName(Word TraceFlag)/* overload */;
extern PACKAGE AnsiString __fastcall GetTraceFlagName(const Sqlexpr::pSQLTRACEDesc30 TraceInfo)/* overload */;
extern PACKAGE AnsiString __fastcall GetTraceMessage(const Sqlexpr::pSQLTRACEDesc30 TraceInfo);
extern PACKAGE void __fastcall DecodeTraceInfo(const Sqlexpr::pSQLTRACEDesc30 TraceInfo, int &TraceFlag, AnsiString &TraceFlagName, AnsiString &TraceMessage);
