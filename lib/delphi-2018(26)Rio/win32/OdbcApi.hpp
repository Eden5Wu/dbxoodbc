...
// (DO NOT EDIT: machine generated header) 'OdbcApi.pas' rev: 33.00 (Windows)
...
__interface DELPHIINTERFACE IOdbcApi;
...
typedef short __stdcall (*TTraceCloseLogFile)();

typedef void __stdcall (*TTraceReturn)(short _1, short _2);

typedef int __stdcall (*TTraceVersion)();

typedef short __stdcall (*TTraceVSControl)(int _1);

typedef System::LongBool __stdcall (*TODBCSetTryWaitValue)(unsigned dwValue);

typedef int __stdcall (*TODBCGetTryWaitValue)();
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EOdbcApi(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EOdbcApi(NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EOdbcApi(System::PResStringRec ResStringRec)/* overload */ : System::Sysutils::Exception(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EOdbcApi(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EOdbcApi(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EOdbcApi(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EOdbcApi(NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EOdbcApi(System::PResStringRec ResStringRec, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EOdbcApi(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EOdbcApi(NativeUInt Ident, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
	/* Exception.Destroy */ inline __fastcall virtual ~EOdbcApi() { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EOdbcApiNotImplemented(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EOdbcApi(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EOdbcApiNotImplemented(NativeUInt Ident)/* overload */ : EOdbcApi(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EOdbcApiNotImplemented(System::PResStringRec ResStringRec)/* overload */ : EOdbcApi(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EOdbcApiNotImplemented(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EOdbcApi(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EOdbcApiNotImplemented(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EOdbcApi(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EOdbcApiNotImplemented(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EOdbcApi(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EOdbcApiNotImplemented(NativeUInt Ident, int AHelpContext)/* overload */ : EOdbcApi(Ident, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EOdbcApiNotImplemented(System::PResStringRec ResStringRec, int AHelpContext)/* overload */ : EOdbcApi(ResStringRec, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EOdbcApiNotImplemented(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : EOdbcApi(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EOdbcApiNotImplemented(NativeUInt Ident, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : EOdbcApi(Ident, Args, Args_High, AHelpContext) { }
	/* Exception.Destroy */ inline __fastcall virtual ~EOdbcApiNotImplemented() { }
...
private:
	...
	NativeUInt hModuleApi;
	System::AnsiString fModuleNameTrac;
	NativeUInt hModuleApiTrac;
	System::AnsiString fModuleNameInst;
	NativeUInt hModuleApiInst;
	...
	void __fastcall BeginLock();
	void __fastcall EndLock();
	
public:
	__fastcall virtual ~TOdbcApiProxy();
	...
	short __fastcall TraceCloseLogFile();
	void __fastcall TraceReturn(short _1, short _2);
	int __fastcall TraceVersion();
	...
	int __fastcall ODBCGetTryWaitValue();
public:
	/* TObject.Create */ inline __fastcall TOdbcApiProxy() : System::TObject() { }
...
__interface  INTERFACE_UUID("{6DA86068-0BC3-4BFC-B9FC-FF8FEC5CD106}") IOdbcApi  : public System::IInterface 
{
	...
	virtual short __fastcall TraceCloseLogFile() = 0 ;
	virtual void __fastcall TraceReturn(short _1, short _2) = 0 ;
	virtual int __fastcall TraceVersion() = 0 ;
	...
	virtual int __fastcall ODBCGetTryWaitValue() = 0 ;
};
...
private:
	...
	void __fastcall CheckAvailableProxy();
...
protected:
	...
	int __fastcall ODBCGetTryWaitValue();
public:
	/* TObject.Create */ inline __fastcall TOdbcApiIntfImpl() : System::TInterfacedObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TOdbcApiIntfImpl() { }
...
extern DELPHI_PACKAGE System::AnsiString sysodbclib;
extern DELPHI_PACKAGE bool __fastcall SQL_SUCCEEDED(const short rc);
extern DELPHI_PACKAGE TOdbcApiProxy* __fastcall LoadOdbcDriverManager(char * LibraryName, bool UnicodePriority = false);
extern DELPHI_PACKAGE void __fastcall UnLoadOdbcDriverManager(TOdbcApiProxy* OdbcApi);
}	/* namespace Odbcapi */
