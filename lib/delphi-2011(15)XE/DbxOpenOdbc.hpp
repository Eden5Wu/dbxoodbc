...
// (DO NOT EDIT: machine generated header) 'DbxOpenOdbc.pas' rev: 22.00
...
public:
	/* Exception.Create */ inline __fastcall EDbxErrorCustom(const System::UnicodeString Msg) : Sysutils::Exception(Msg) { }
	/* Exception.CreateFmt */ inline __fastcall EDbxErrorCustom(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	/* Exception.CreateRes */ inline __fastcall EDbxErrorCustom(int Ident)/* overload */ : Sysutils::Exception(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EDbxErrorCustom(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : Sysutils::Exception(Ident, Args, Args_Size) { }
	/* Exception.CreateHelp */ inline __fastcall EDbxErrorCustom(const System::UnicodeString Msg, int AHelpContext) : Sysutils::Exception(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EDbxErrorCustom(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EDbxErrorCustom(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size, int AHelpContext)/* overload */ : Sysutils::Exception(ResStringRec, Args, Args_Size, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EDbxOdbcWarning(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : EDbxErrorCustom(Msg, Args, Args_Size) { }
	/* Exception.CreateRes */ inline __fastcall EDbxOdbcWarning(int Ident)/* overload */ : EDbxErrorCustom(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EDbxOdbcWarning(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : EDbxErrorCustom(Ident, Args, Args_Size) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EDbxOdbcWarning(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : EDbxErrorCustom(Msg, Args, Args_Size, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EDbxOdbcWarning(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size, int AHelpContext)/* overload */ : EDbxErrorCustom(ResStringRec, Args, Args_Size, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EDbxError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : EDbxErrorCustom(Msg, Args, Args_Size) { }
	/* Exception.CreateRes */ inline __fastcall EDbxError(int Ident)/* overload */ : EDbxErrorCustom(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EDbxError(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : EDbxErrorCustom(Ident, Args, Args_Size) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EDbxError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : EDbxErrorCustom(Msg, Args, Args_Size, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EDbxError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size, int AHelpContext)/* overload */ : EDbxErrorCustom(ResStringRec, Args, Args_Size, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EDbxOdbcError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : EDbxError(Msg, Args, Args_Size) { }
	/* Exception.CreateRes */ inline __fastcall EDbxOdbcError(int Ident)/* overload */ : EDbxError(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EDbxOdbcError(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : EDbxError(Ident, Args, Args_Size) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EDbxOdbcError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : EDbxError(Msg, Args, Args_Size, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EDbxOdbcError(int Ident, int AHelpContext)/* overload */ : EDbxError(Ident, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EDbxOdbcError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size, int AHelpContext)/* overload */ : EDbxError(ResStringRec, Args, Args_Size, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EDbxNotSupported(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : EDbxError(Msg, Args, Args_Size) { }
	/* Exception.CreateRes */ inline __fastcall EDbxNotSupported(int Ident)/* overload */ : EDbxError(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EDbxNotSupported(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : EDbxError(Ident, Args, Args_Size) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EDbxNotSupported(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : EDbxError(Msg, Args, Args_Size, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EDbxNotSupported(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size, int AHelpContext)/* overload */ : EDbxError(ResStringRec, Args, Args_Size, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EDbxInvalidCall(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : EDbxError(Msg, Args, Args_Size) { }
	/* Exception.CreateRes */ inline __fastcall EDbxInvalidCall(int Ident)/* overload */ : EDbxError(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EDbxInvalidCall(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : EDbxError(Ident, Args, Args_Size) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EDbxInvalidCall(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : EDbxError(Msg, Args, Args_Size, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EDbxInvalidCall(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size, int AHelpContext)/* overload */ : EDbxError(ResStringRec, Args, Args_Size, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EDbxInternalError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : EDbxError(Msg, Args, Args_Size) { }
	/* Exception.CreateRes */ inline __fastcall EDbxInternalError(int Ident)/* overload */ : EDbxError(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EDbxInternalError(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : EDbxError(Ident, Args, Args_Size) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EDbxInternalError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : EDbxError(Msg, Args, Args_Size, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EDbxInternalError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size, int AHelpContext)/* overload */ : EDbxError(ResStringRec, Args, Args_Size, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EDbxInvalidParam(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : EDbxError(Msg, Args, Args_Size) { }
	/* Exception.CreateRes */ inline __fastcall EDbxInvalidParam(int Ident)/* overload */ : EDbxError(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EDbxInvalidParam(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : EDbxError(Ident, Args, Args_Size) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EDbxInvalidParam(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : EDbxError(Msg, Args, Args_Size, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EDbxInvalidParam(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size, int AHelpContext)/* overload */ : EDbxError(ResStringRec, Args, Args_Size, AHelpContext) { }
...
typedef Classes::TList TDbxConStmtList;
...
protected:
	...
	void __fastcall CreateRegExpObjectNameParser(Dbxobjectparser::PObjectNameTemplateInfo AObjectNameTemplateInfo, const System::AnsiString DbQuote, const System::AnsiString sRegExpNew = "");
	...
	void __fastcall DbxCallBackSendMsgFmt(int TraceCat, const System::AnsiString FmtMsg, System::TVarRec const *FmtArgs, const int FmtArgs_Size);
...
protected:
	...
	int __stdcall isNullable(System::Word ColumnNumber, BOOL &Nullable);
	int __stdcall isAutoIncrement(System::Word ColumnNumber, BOOL &AutoIncr);
	int __stdcall isReadOnly(System::Word ColumnNumber, BOOL &ReadOnly);
	int __stdcall isSearchable(System::Word ColumnNumber, BOOL &Searchable);
	int __stdcall isBlobSizeExact(System::Word ColumnNumber, BOOL &IsExact);
	int __stdcall next(void);
	int __stdcall getString(System::Word ColumnNumber, char * Value, BOOL &IsBlank);
	int __stdcall getShort(System::Word ColumnNumber, void * Value, BOOL &IsBlank);
	int __stdcall getLong(System::Word ColumnNumber, void * Value, BOOL &IsBlank);
	int __stdcall getDouble(System::Word ColumnNumber, void * Value, BOOL &IsBlank);
	int __stdcall getBcd(System::Word ColumnNumber, void * Value, BOOL &IsBlank);
	int __stdcall getTimeStamp(System::Word ColumnNumber, void * Value, BOOL &IsBlank);
	int __stdcall getTime(System::Word ColumnNumber, void * Value, BOOL &IsBlank);
	int __stdcall getDate(System::Word ColumnNumber, void * Value, BOOL &IsBlank);
	int __stdcall getBytes(System::Word ColumnNumber, void * Value, BOOL &IsBlank);
	int __stdcall getBlobSize(System::Word ColumnNumber, unsigned &iLength, BOOL &IsBlank);
	int __stdcall getBlob(System::Word ColumnNumber, void * Value, BOOL &IsBlank, unsigned iLength);
...
protected:
	...
	void __fastcall remap(System::Word iPhCursor, System::Word iPhSrc, const System::AnsiString sNewName = "", int iNewType = 0x1, int iNewPhSize = 0x0);
	int __stdcall SetOption(Dbxopenodbcdbx3types::TSQLCursorOption eOption, int PropValue);
	int __stdcall GetOption(Dbxopenodbcdbx3types::TSQLCursorOption eOption, void * PropValue, short MaxLength, /* out */ short &iLength);
	int __stdcall getErrorMessage(char * Error);
	int __stdcall getErrorMessageLen(/* out */ short &ErrorLen);
...
extern PACKAGE Dbxopenodbcinterface::TConnectionOptions cConnectionOptionsDefault;
extern PACKAGE TConnectionOptionsRestrictions cConnectionOptionsRestrictions;
static const System::ShortInt cConnectionTimeoutDefault = -1;
static const System::Word cBlobChunkSizeMin = 0x100;
static const int cBlobChunkSizeMax = 0xfa000;
static const System::Word cBlobChunkSizeDefault = 0xa000;
static const System::Word cNetwrkPacketSizeDefault = 0x2000;
static const System::Word cNetwrkPacketSizeMin = 0x200;
static const System::ShortInt coNetTimeoutDefault = -1;
static const System::ShortInt cLockModeDefault = -1;
extern PACKAGE THostPlatform gHostPlatform;
extern PACKAGE TBindMapDateTimeOdbc cBindMapDateTimeOdbc2;
extern PACKAGE TBindMapDateTimeOdbc cBindMapDateTimeOdbc3;
static const System::Word dsMaxStringSize = 0x2000;
extern PACKAGE char cDecimalSeparatorDefault;
static const System::Word cOdbcReturnedConnectStringMax = 0x800;
static const System::ShortInt cMaxBcdCharDigits = 0x40;
static const System::Word cStatementPerConnectionBlockCount = 0x200;
static const System::ShortInt cMaxCacheConnectionCount = 0x10;
static const System::ShortInt cMaxCacheNullConnectionCount = 0x10;
static const System::Byte cOdbcMaxColumnNameLenDefault = 0x80;
static const System::Byte cOdbcMaxTableNameLenDefault = 0x80;
static const System::Word cOdbcMaxCatalogNameLenDefault = 0x400;
static const System::Word cOdbcMaxSchemaNameLenDefault = 0x400;
static const System::Byte cOdbcMaxIdentifierLenDefault = 0x80;
static const System::ShortInt DBX_SQL_NULL_DATA = 0x64;
static const System::Byte DBX_DRIVER_ERROR = 0xff;
static const System::ShortInt SQL_SUCCESS = 0x0;
static const System::ShortInt eSQLSystemView = 0x40;
