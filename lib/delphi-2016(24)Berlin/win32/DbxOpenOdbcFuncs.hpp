...
// (DO NOT EDIT: machine generated header) 'DbxOpenOdbcFuncs.pas' rev: 31.00 (Windows)
...
extern DELPHI_PACKAGE System::UnicodeString __fastcall GetCompilerVersion(void);
}	/* namespace Dbxopenodbcfuncs */
