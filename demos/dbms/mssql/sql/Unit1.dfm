object Form1: TForm1
  Left = 277
  Top = 188
  Caption = 'dbxoodbx:: demo dbx access to MS SQL'
  ClientHeight = 579
  ClientWidth = 778
  Color = clBtnFace
  ...
  object chk_msdriver: TCheckBox
    Left = 39
    Top = 84
    Width = 134
    Height = 17
    Caption = 'Microsoft oracle driver'
    TabOrder = 4
  end
  ...
  object SQLConnection: TSQLConnection
    ...
    Params.Strings = (
      ...
      'Database=?'
        ...
        'ConnectionString=DRIVER={SQL Native Client};Trusted_Connection=Y' +
        'es;SERVER=127.0.0.1\SQLEXPRESS;DATABASE=dbxoodbc;coTrimChar=True' +
        ';coLockMode=60;coCatPrefix=DATABASE'
      '-MetadataDBX=True')
    TableScope = [tsTable]
    VendorLib = 'sqlncli.dll;sqlncli10.dll;sqlsrv32.dll'
