...
public:
	...
	__fastcall TMetaIndexColumn(TMetaTable* MetaTable, wchar_t * CatName, wchar_t * SchemaName, wchar_t * TableName, wchar_t * IndexName, char * IndexColumnName);
...
public:
	...
	__fastcall TMetaTable(TSqlConnectionOdbc* SqlConnectionOdbc, wchar_t * Cat, wchar_t * Schema, wchar_t * TableName, int TableType, wchar_t * Remarks);
...
public:
	...
	__fastcall TMetaColumn(wchar_t * ColumnName, short OrdinalPosition, wchar_t * TypeName, wchar_t * DefaultValue, wchar_t * Remarks);
...
public:
	...
	__fastcall TMetaProcedure(wchar_t * Cat, wchar_t * Schema, wchar_t * ProcName, int ProcType);
...
public:
	...
	__fastcall TMetaProcedureParam(wchar_t * ParamName);
...
protected:
	...
	bool __fastcall DescribeAllocBindWString(Word ColumnNo, wchar_t * &BindString, int &BindInd, bool bIgnoreError = false);
...
struct TOdbcBindParamRec
{
	...
	union
	{
		...
		struct 
		{
			wchar_t OdbcParamValueWideString[129];
