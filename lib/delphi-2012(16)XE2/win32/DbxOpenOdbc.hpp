...
// (DO NOT EDIT: machine generated header) 'DbxOpenOdbc.pas' rev: 23.00 (Win32)
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EDbxErrorCustom(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : System::Sysutils::Exception(Msg, Args, Args_Size) { }
	/* Exception.CreateRes */ inline __fastcall EDbxErrorCustom(int Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EDbxErrorCustom(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_Size) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EDbxErrorCustom(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EDbxErrorCustom(int Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EDbxErrorCustom(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_Size, AHelpContext) { }
...
enum Dbxopenodbc__9 : unsigned char { hpWindows, hpLinux, hpMACOS, hpCLR, hp32Bit, hp64bit };
#pragma option pop

typedef System::Set<Dbxopenodbc__9, Dbxopenodbc__9::hpWindows, Dbxopenodbc__9::hp64bit>  THostPlatform;

#pragma option push -b-
enum TConnectionOptionRestriction : unsigned char { cor_connection_off, cor_ActiveCursors0, cor_driver_off };
#pragma option pop
...
#pragma option push -b-
enum TBindMapDateTimeOdbcIndexes : unsigned char { biDate, biTime, biDateTime };
#pragma option pop
...
#pragma option push -b-
enum TDOSQLObjectType : unsigned char { otDOSQLUnknown, otDOSQLDriver, otDOSQLConnection, otDOSQLCommand, otDOSQLMetaData, otDOSQLCursor, otDOSQLCursorMetadata };
#pragma option pop
...
#pragma option push -b-
enum Dbxopenodbc__31 : unsigned char { scsStmtBinded, scsStmtExecuted, scsIsCursor };
#pragma option pop
...
extern PACKAGE void __fastcall CheckMaxLines(System::Classes::TStringList* List);
