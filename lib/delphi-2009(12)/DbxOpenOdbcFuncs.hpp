...
// (DO NOT EDIT: machine generated header) 'Dbxopenodbcfuncs.pas' rev: 20.00
...
extern PACKAGE System::AnsiString __fastcall GetOptionValue(System::AnsiString &ConnectString, System::AnsiString OptionName, bool HideOption = false, bool TrimResult = true, bool bOneChar = false, const System::AnsiString HideTemplate = "");
...
extern PACKAGE System::UnicodeString __fastcall GetTemporaryFolder();
...
extern PACKAGE System::UnicodeString __fastcall GetCompilerVersion();
